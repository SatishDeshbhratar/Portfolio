...
- After an algorithm reaches the human level performance the progress and accuracy slow down.
  ![01- Why human-level performance](/static/blogs/01-_Why_human-level_performance.png)
