---
title: 'Deep Learning Specialization: Improving Deep Neural Networks - Hyperparameter tuning, Regularization and Optimization'
date: '2023-12-08'
tags: ['deep-learning', 'coursera']
draft: false
summary: 'This is the second course of the deep learning specialization at Coursera'
images: ['/static/blogs/dl2.jpeg']
authors: ['default']
---
...
- So here the explanation of Bias / Variance:
  ...
  - For more:
    - ![](/static/blogs/01-_Bias_-_Variance.png)
...
- **Early stopping**:
  ...
  - We will take these parameters as the best parameters.
    - ![](/static/blogs/02-_Early_stopping.png)
...
- There's a numerical way to calculate the derivative:  
  ![](/static/blogs/03-_Numerical_approximation_of_gradients.png)
...
- In mini-batch algorithm, the cost won't go down with each step as it does in batch algorithm. It could contain some ups and downs but generally it has to go down (unlike the batch gradient descent where cost function descreases on each iteration).
  ![](/static/blogs/04-_batch_vs_mini_batch_cost.png)
- Mini-batch size:
...
- Another imagery example:  
   ![](/static/blogs/Nasdaq1_small.png)  
   _(taken from [investopedia.com](https://www.investopedia.com/))_

### Understanding exponentially weighted averages

- Intuitions:  
   ![](/static/blogs/05-_exponentially_weighted_averages_intuitions.png)
